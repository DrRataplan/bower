...
Manager.prototype.toData = function (decEndpoint, extraKeys, upperDataByName) {
    var names;
    var extra;

    var data = {};

    upperDataByName = upperDataByName || {};
    if (upperDataByName[decEndpoint.name]) {
        return upperDataByName[decEndpoint.name];
    }

    upperDataByName[decEndpoint.name] = data;
    ...
    if (decEndpoint.dependencies) {
        ...
        names.forEach(function (name) {
            ...
            // dependencies
            if (!mout.object.hasOwn(upperDataByName, name)) {
